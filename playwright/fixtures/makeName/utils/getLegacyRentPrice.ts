...
export const getLegacyRentPrice = async ({
  ...
  try {
    console.log("🚀 ~ publicClient.chain.contracts.legacyRegistrarController.addres:", publicClient.chain.contracts.legacyRegistrarController.address)
    ...
    console.log('🚀 ~ getLegacyRentPrice ~ error:', error)
  }
}
